...
<div id="main" class="container-fluid" style="background-color:#FBFBF0">
	<div class="row">
		...
		<!--<div id="content" class="col-xs-12 col-sm-12">-->
			...
			<!--<div id="file_list" class="statusbar" style="width:1000px;margin-left:15px;padding-bottom:10px">
				<span class="filename" style="text-align:center;width:400px">檔案名稱</span>
				<span class="filesize" style="width:200px;">檔案大小</span>
