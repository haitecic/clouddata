...
<div id="main" class="container-fluid" style="background-color:#FBFBF0">
	<div class="row">
		...
		<!--<form class="form-horizontal" role="form" id="project_create_form" name="project_create_form" enctype="multipart/form-data">-->
		<div style="padding-left:24px"><span style="font-size:21pt;">專案資料新增</span><span style="font-size:14pt">( <span style="color:red">*</span> 為必填欄位 )</span></div>
		<br/>
		...
		echo form_open('project_create', $attributes);
		?>		
			<div class="form-group">	
				...
				<div class="col-sm-4">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" class="form-control" id="project_name" name="project_name" placeholder="" data-toggle="tooltip" data-placement="bottom" title="專案主題" style="font-size:17px; font-family:微軟正黑體;">  
				</div>
					
				<label class="col-sm-1  control-label" style="font-family: Adobe 繁黑體 Std; font-size:17px;"><span style="color:red;font-size:13pt">* </span>專案年份</label>
				<div class="col-sm-4">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_year_border_display(this)" onblur="change_year_border_display_onblur(this,event)" class="form-control" id="year" name="year" placeholder="請輸入西元年(例如:2015)" data-toggle="tooltip" data-placement="bottom" title="專案年份" style="font-size:17px; font-family:微軟正黑體;">  
				</div>				
			</div>

			<div class="col-xs-12 col-sm-12" style="height:10px; "></div><!--background-color:#ffffff; -->

			<div class="form-group">	
				<label class="col-sm-1  col-sm-offset-1 control-label" style="font-family: Adobe 繁黑體 Std; font-size:17px;"><span style="color:red;font-size:13pt">* </span>華創單位</label>
				<div class="col-sm-4">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" class="form-control" id="haitec_unit" name="haitec_unit" data-toggle="tooltip" data-placement="bottom" title="華創單位" style="font-size:17px; font-family:微軟正黑體;" placeholder="多個單位請以分號(;)區隔">  
				</div>
					
				<label class="col-sm-1  control-label" style="font-family: Adobe 繁黑體 Std; font-size:17px;"><span style="color:red;font-size:13pt">* </span>外部單位</label>
				<div class="col-sm-4">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" class="form-control" id="outer_unit" name="outer_unit" data-toggle="tooltip" data-placement="bottom" title="外部單位" style="font-size:17px; font-family:微軟正黑體;" placeholder="多個單位請以分號(;)區隔">  
				</div>				
			</div>
			...
			<div class="form-group">	
				...
				<div class="col-sm-4">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" class="form-control" id="pm" name="pm" data-toggle="tooltip" data-placement="bottom" title="創意中心負責人" style="font-size:17px; font-family:微軟正黑體;" placeholder="多個負責人請以分號(;)區隔">  
				</div>
			</div>

			<div class="row form-group">	
				<label class="col-sm-2   control-label" style="font-family: Adobe 繁黑體 Std; font-size:17px;"><span style="color:red;font-size:13pt">* </span>納入車型評估</label>
				<div class="col-sm-3">
					<div class="radio-inline">
						<label>
							<input type="radio" value="1" name="car_model_estimate" checked >是
							<i class="fa fa-circle-o"></i>
						</label>
					</div>
					<div class="radio-inline">
						<label>
							<input type="radio" value="2" name="car_model_estimate">否
							<i class="fa fa-circle-o"></i>
						</label>
					</div>
				</div>	
				...
				<div class="col-sm-4">
					<div class="radio-inline">
						<label>
							<input type="radio" value="1" name="exhibition" checked >是
							<i class="fa fa-circle-o"></i>
						</label>
					</div>
					<div class="radio-inline">
						<label>
							<input  type="radio" value="2" name="exhibition">否
							<i class="fa fa-circle-o"></i>
						</label>
					</div>
				</div>	
			...
			<div class="row form-group">	
				...
				<div class="col-sm-4">
					...
					<div class="radio-inline">
						<label>
							<input  type="radio" name="status" value="2">結案
							<i class="fa fa-circle-o"></i>
						</label>
					</div>
				</div>	
			...
			<div class="form-group">	
				...
				<div class="col-sm-2">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" id="keyword" name="keyword" class="form-control" placeholder="關鍵字請以分號(;)區隔" data-toggle="tooltip" data-placement="bottom" title="專案主題" style="width:900px;font-size:17px; font-family:微軟正黑體;">  
				</div>				
			</div>
			<div class="form-group">	
				...
				<div class="col-sm-2">
					<input type="text" onfocus="change_border_display_onfocus(this)" onchange="change_border_display(this)" onblur="change_border_display_onblur(this)" id="idea_id" name="idea_id" class="form-control" placeholder="創意提案編號" data-toggle="tooltip" data-placement="bottom" title="創意提案編號" style="width:900px;font-size:17px; font-family:微軟正黑體;">  
				</div>				
			</div>
		...
		<!--<div id="content" class="col-xs-12 col-sm-12">-->
			...
			<div style="margin-left:15px" id="dragandrophandler">Drag & Drop Files Here</div>
			<div id="status1"></div>
...
{		
	...
	$("#sub_button").click(function () {  //按下資料送出的處理函數
		...
		*/
		...
		//判斷是否有上傳檔案
		if(document.getElementById("file_count").value == 0)
		{
			pass_validation = false;
		...
		{
			/*var success_upload_file_count = parseInt(document.getElementById("file_success_upload_count").value);
			var total_upload_file_count = parseInt(document.getElementById("file_count").value);
			alert(total_upload_file_count +">>"+success_upload_file_count);
			if(success_upload_file_count != total_upload_file_count)
			{
				pass_validation = false;
		...
		/*for (var i = 0; i < files.length; i++)  //處理使用者一次拖曳的一個或多個檔案
		{
			...
			sendFileToServer(fd, status_arr[i]);
		}*/
    });
...
function createStatusbar(obj)
{
    ...
    this.statusbar = $("<div class='statusbar "+row+"' style='width:1000px'></div>");  //先產生一個狀態列(row)
    ...
    this.abort = $("<div id='"+(rowCount-1)+"' class='abort' style='margin-left:50px'>Cancel</div>").appendTo(this.statusbar);
...
{	
	...
	//var uploadURL = "http://localhost/project_manager/project_file_upload";
